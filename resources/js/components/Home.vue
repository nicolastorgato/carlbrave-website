...
<div>
    ...
    <div class="flex flex-col sm:flex-row mb-8 mt-0 sm:mt-32">
        ...
        <div class="w-full flex flex-col items-center justify-around sm:justify-center">
            ...
            <a href="https://braveshop23.bigcartel.com/" target="_blank">
                <button  class="mt-10 border border-teal-500 text-teal-500 block rounded-md font-bold text-lg tracking-wider py-3 px-5 mr-2 flex items-center hover:bg-teal-500 hover:text-white focus:outline-none">
            ...
            <div class="w-1/2 sm:w-1/5 flex items-center justify-around mt-10">
                ...
                <a href="https://it-it.facebook.com/carlbrave23/" target="_blank">
                ...
                <a href="https://www.youtube.com/channel/UCgFZq7T7O4kbFqY63Mrmypw" target="_blank">
