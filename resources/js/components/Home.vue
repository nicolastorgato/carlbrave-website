    ...
    <div class="flex flex-col sm:flex-row mb-8 mt-0 sm:mt-32">
        ...
        <div class="w-full flex flex-col items-center justify-around sm:justify-center">
            ...
            <a href="https://braveshop23.bigcartel.com/" target="_blank">
                <button  class="mt-10 border border-teal-500 text-teal-500 block rounded-md font-bold text-lg tracking-wider py-4 px-6 mr-2 flex items-center hover:bg-teal-500 hover:text-white focus:outline-none">
