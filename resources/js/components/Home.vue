...
<div>
    ...
    <div class="flex flex-col sm:flex-row mb-8 mt-0 sm:mt-32">
        ...
        <div class="w-full flex flex-col items-center justify-around sm:justify-center">

            <h1 class="text-6xl text-gray-800">Carl Brave</h1>

            <p class="text-2xl text-gray-600 text-center"> 
                Foto, video, lyrics, polaroid e tanti altri contenuti!
            </p>

            <a class="" href="https://braveshop23.bigcartel.com/" target="_blank">
                <button  class="mt-10 border border-teal-500 text-teal-500 block rounded-md font-bold text-lg tracking-wider py-3 px-5 mr-2 flex items-center hover:bg-teal-500 hover:text-white focus:outline-none transition duration-500 ease-in-out transform hover:scale-105">
            ...
            <div class="w-1/2 sm:w-1/5 flex items-center justify-around mt-10">
                <a class="transition duration-500 ease-in-out transform hover:scale-125" href="https://www.instagram.com/carlbrave23/" target="_blank">
                    <svg class="h-5 w-5" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <linearGradient id="SVGID_1_" gradientTransform="matrix(0 -1.982 -1.844 0 -132.522 -51.077)" gradientUnits="userSpaceOnUse" x1="-37.106" x2="-26.555" y1="-72.705" y2="-84.047">
                            <stop offset="0" stop-color="#fd5"/><stop offset=".5" stop-color="#ff543e"/><stop offset="1" stop-color="#c837ab"/>
                ...
                <a class="transition duration-500 ease-in-out transform hover:scale-125" href="https://it-it.facebook.com/carlbrave23/" target="_blank">
                    <svg class="h-5 w-5" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="transition duration-500 ease-in-out transform hover:scale-125" href="https://www.youtube.com/channel/UCgFZq7T7O4kbFqY63Mrmypw" target="_blank">
                    <svg class="h-6 w-6" viewBox="0 -77 512.00213 512" xmlns="http://www.w3.org/2000/svg">
